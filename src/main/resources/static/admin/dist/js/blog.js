$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '浏览量', name: 'blogViews', index: 'blogViews', width: 30},
            ...
            {label: '添加时间', name: 'createTime', index: 'createTime', width: 90,formatter:'date',formatoptions: {newformat:'Y-m-d'}}
        ],
        height: 700,
        rowNum: 5,
        rowList: [10, 20, 50],
    ...
    function coverImageFormatter(cellvalue) {
        return "<img src='" + cellvalue + "' height=\"120\" width=\"100%\" style='object-fit:cover;' alt='coverImage'/>";
    }
